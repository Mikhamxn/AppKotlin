...
data class UsersData(val nombre: String = "", val correo: String = "", val matricula: String = "", val carrera: String = "") {
...
class DesarrolloActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val carreraQuery: Query = databaseReference.orderByChild("carrera").equalTo("Desarrollo")
        ...
        carreraQuery.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    val adapter = ArrayAdapter(this@DesarrolloActivity, android.R.layout.simple_list_item_1, list)
