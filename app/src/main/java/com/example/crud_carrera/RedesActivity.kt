...
class RedesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val carreraQuery: Query = databaseReference.orderByChild("carrera").equalTo("Redes")
        ...
        carreraQuery.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    val adapter = ArrayAdapter(this@RedesActivity, android.R.layout.simple_list_item_1, list)
